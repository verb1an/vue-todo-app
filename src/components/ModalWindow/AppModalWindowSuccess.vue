<template>
    <Transition>
        <div v-if="content.show" class="component modal success">
            ...
            <div class="modal__body">
                ...
                <div class="buttons">
                    <button type="button" data-type="yes" @click="$emit('modal:success', content.func)">
                        <span class="i-trash-alt"></span>
                        <span>{{ content.btn.yes }}</span>
                    </button>
                    <button type="button" data-type="no" @click="$emit('modal:close')">
                        <span>{{ content.btn.no }}</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    .modal__body {
        ...
        .buttons {
            ...
            button {
                ...
                &:first-child {
                    background: linear-gradient(135deg, #FA4F58 0%, #FF7F8C 100%);
